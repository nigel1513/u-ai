...
def chat_bot():
    proxies = {
        'http': 'https://nigel-u-ai.streamlit.app/:8080',
        'https': 'https://nigel-u-ai.streamlit.app/:8080'}
    ...
    if prompt:
        ...
        with st.chat_message("user"):
            st.write(prompt)
        bard = BardCookies(cookie_dict=cookie_dict, proxies=proxies, session=session, conversation_id=st.session_state.conversation_id)
